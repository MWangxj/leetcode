...
goos: darwin
goarch: amd64
BenchmarkAddBinary1-4            3000000               437 ns/op             320 B/op          3 allocs/op
BenchmarkAddBinaryMy1-4          3000000               426 ns/op             320 B/op          3 allocs/op
PASS
...
func addBinaryMy1(a string, b string) string {
	i := len(a) - 1
	j := len(b) - 1
	var s string
	var c uint8
...
func BenchmarkAddBinary1(b *testing.B) {
...
func BenchmarkAddBinaryMy1(b *testing.B) {
	a1 := "10100000100100110110010000010101111011011001101110111111111101000000101111001110001111100001101"
	b1 := "110101001011101110001111100110001010100001101011101010000011011011001011101111001100000011011110011"
	for i := 0; i < b.N; i++ {
		addBinary1(a1, b1)
